...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/mp-cb-ws/pipeline-template-catalog.git");
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>mp-cb-ws</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/mp-cb-ws/pipeline-template-catalog.git</repositoryUrl>
              <traits>
